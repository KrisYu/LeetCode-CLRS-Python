...
好吧，原来可以不用这样，利用题目特性 “there exists one unique longest palindromic substring.”
...
在查看wikipedia，有一个[Longest palindromic substring](https://en.wikipedia.org/wiki/Longest_palindromic_substring), 有一个Manacher算法
